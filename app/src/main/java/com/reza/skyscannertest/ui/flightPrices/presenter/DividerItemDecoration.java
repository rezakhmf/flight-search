...
import com.reza.skyscannertest.ui.flightPrices.adapter.ListItem;
...
//                final int bottom = mBounds.bottom + Math.round(child.getTranslationY());
            ...
            mPaint.setARGB(1, 255,69,0);
            //int mHeightDp = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, heightDp, context.getResources().getDisplayMetrics());


            if (viewType == ListItem.Companion.getTYPE_FLIGHT_INFO()) {
                mDivider.setBounds(left, top, right , bottom+ 100);
                mDivider.draw(canvas);
            }
        }
